...
<head>
    <meta charset="UTF-8">
    <title>Visit Us | Mentora Nexus - Explore Our Locations</title>
...
<body>
    <div class="warpper">
        ...
        <div id="content">
            ...
            <p><strong>About Our Locations</strong></p>
            <p>
                Mentora Nexus started its journey in 2010 with a mission to empower learners and professionals in the
                field of computer science.
                Our library specializes in providing a comprehensive collection of academic textbooks, catering to
                diverse topics such as programming,
                networking, artificial intelligence, and software engineering. Each location is thoughtfully curated to
                offer a quiet and resourceful
                environment for students, researchers, and enthusiasts. Whether you're seeking foundational knowledge or
                advanced concepts, Mentora Nexus
                is your trusted partner in academic success.
            </p>

            <p>
                To explore our different branches, please visit the
                <a href="locations.php">Locations</a> page. For detailed opening hours, check the
                <a href="opening-times.php">Opening Times</a> page.
            </p>
        </div>
